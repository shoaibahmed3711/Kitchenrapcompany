...
const HrRequest = () => {
  ...
  return (
    ...
    <div className='flex flex-row m-[1vw] gap-[1vw] items-center image-hover-effect'>
      <div className='w-[3vw]'>
      <img src="/images/HRM/Request.png" className="image-hover-effect" alt="Leave" />
      </div>
      <h1 className=' text-[2vw] text-[#E9278E]'>Hr Request</h1>
      </div>
        ...
        <table className="w-[80vw] overflow-y-auto">
          <thead className="bg-gray-300 w-[80vw]">
            <tr className="w-[80vw]">
              ...
              <th className="border p-[0.5vw] text-[1vw]">Advance Purpose</th>
              <th className="border p-[0.5vw] text-[1vw]">Advance Date</th>
              <th className="border p-[0.5vw] text-[1vw]">Amount</th>
              <th className="border p-[0.5vw] text-[1vw]">Installment Count</th>
          ...
          <tbody className="rounded-lg bg-gray-100 w-[80vw] text-center">
            {filteredRows.map((row, index) => (
              <tr key={index}>
                ...
                <td className="p-[1.5vw]">{row.advancePurpose}</td>
                <td className="p-[1.5vw]">{new Date(row.advanceDate).toLocaleDateString()}</td>
                <td className="p-[1.5vw]">{row.amount}</td>
                <td className="p-[1.5vw]">{row.installmentCount}</td>
                <td>
                  <select
      ...
      {!isFormVisible && (
        <div className="absolute bottom-4 left-4">
          <button
            className="w-[4vw] text-white  rounded"
      ...
      {isFormVisible && (
        <div className="w-[26vw] bg-white shadow-2xl absolute right-0 z-10 top-[0vw] overflow-y-auto rounded-lg ml-4 h-[32vw]">
          ...
          <form onSubmit={handleSubmit} className="overflow-y-auto p-[1vw] ">
            ...
            <div className="mb-[0.3vw]">
              <label htmlFor="advancePurpose" className="block mb-[0.3vw] text-[1vw]">
                Advance Purpose:
              </label>
              <input
                type="text"
                id="advancePurpose"
                name="advancePurpose"
                value={formData.advancePurpose}
                onChange={handleChange}
                className="border p-[0.5vw] rounded w-[22vw] h-[2.5vw]"
              />
            </div>
            <div className="mb-[0.3vw]">
              <label htmlFor="advanceDate" className="block mb-[0.3vw] text-[1vw]">
                Advance Date:
              </label>
              <input
                type="date"
            ...
            <div className="mb-[0.3vw]">
              <label htmlFor="amount" className="block mb-[0.3vw] text-[1vw]">
                Amount:
              </label>
              <input
                type="number"
            ...
            <div className="mb-[0.3vw]">
              <label htmlFor="installmentCount" className="block mb-[0.3vw] text-[1vw]">
                Installment Count:
              </label>
              <input
                type="number"
