...
const ProductSetting = () => {
  ...
  const filteredRows = rows.filter((row) => {
    const name = row.Categoryname ? row.Categoryname.toLowerCase() : '';
  ...
  return (
    ...
    <div className='flex flex-row m-[1vw] gap-[1vw] items-center image-hover-effect'>
      <div className='w-[3vw]'>
      <img src="/Inventory/setting.png" className="image-hover-effect" alt="Leave" />
      </div>
      <h1 className=' text-[2vw] text-[#E9278E]'>Product Setting</h1>
      </div>
