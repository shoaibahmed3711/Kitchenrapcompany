...
const Wherehouse = () => {
  ...
  return (
    ...
    <div className='flex flex-row m-[1vw] gap-[1vw] items-center image-hover-effect'>
      <div className='w-[3vw]'>
      <img src="/Inventory/Warehouse.png" className="image-hover-effect" alt="Leave" />
      </div>
      <h1 className=' text-[2vw] text-[#E9278E]'>Warehouse</h1>
      </div>
        ...
        <table className="w-[80vw] overflow-y-auto">
          <thead className="bg-gray-300 w-[80vw]">
            <tr className="w-[80vw]">
              ...
              <th className="border p-[0.5vw] text-[1vw]">Country</th>
              <th className="border p-[0.5vw] text-[1vw]">City</th>
              <th className="border p-[0.5vw] text-[1vw]">Street</th>
              <th className="border p-[0.5vw] text-[1vw]">Building</th>
              <th className="border p-[0.5vw] text-[1vw]">Floor</th>
              <th className="border p-[0.5vw] text-[1vw]">Office no</th>
              <th className="border p-[0.5vw] text-[1vw]">Land Line</th>
