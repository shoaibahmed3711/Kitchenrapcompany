...
const Product = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (editIndex !== null) {
      ...
      setRows((prevRows) => [...prevRows, { id: srNo, ...formData }]);
      setSrNo(srNo + 1);
    }
        ...
        <table className="w-[80vw] overflow-y-auto">
          <thead className="bg-gray-300 w-[80vw]">
            <tr className="w-[80vw]">
              ...
              <th className="border p-[0.5vw] text-[1vw]">Image</th>
              <th className="border p-[0.5vw] text-[1vw]">Product Name</th>
              <th className="border p-[0.5vw] text-[1vw]">Barcode</th>
              <th className="border p-[0.5vw] text-[1vw]">Supplier Code</th>
              <th className="border p-[0.5vw] text-[1vw]">Coded Code</th>
              <th className="border p-[0.5vw] text-[1vw]">Actual Stock</th>
              <th className="border p-[0.5vw] text-[1vw]">Stock QTY</th>
