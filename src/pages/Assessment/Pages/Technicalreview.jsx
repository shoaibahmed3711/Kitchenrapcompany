...
const Technicalreview = () => {
    ...
    return (
        ...
        <div className='flex flex-row m-[1vw] gap-[1vw] items-center image-hover-effect'>
          <div className='w-[3vw]'>
          <img src="/Assessment/Technicalreview.png" className="image-hover-effect" alt="Leave" />
          </div>
          <h1 className=' text-[2vw] text-[#E9278E]'>Technical Review</h1>
          </div>
                ...
                <table className="w-[80vw] overflow-y-auto">
                    <thead className="bg-gray-300 w-[80vw]">
                        <tr className="w-[80vw]">
                            ...
                            <th className="border p-[0.5vw] text-[1vw]">Request Date</th>
                            <th className="border p-[0.5vw] text-[1vw]">Requested by</th>
                            <th className="border p-[0.5vw] text-[1vw]">Assign Date</th>
                            <th className="border p-[0.5vw] text-[1vw]">Assigned to</th>
                            <th className="border p-[0.5vw] text-[1vw]">Delivery date</th>
                            <th className="border p-[0.5vw] text-[1vw]">Lead/Customer</th>
                            <th className="border p-[0.5vw] text-[1vw]">Contact</th>
                            <th className="border p-[0.5vw] text-[1vw]">Project</th>
                            <th className="border p-[0.5vw] text-[1vw]">Production Order Date</th>
                    ...
                    <tbody className="rounded-lg bg-gray-100 w-[80vw] text-center">
                        {filteredRows.map((row, index) => (
                            <tr key={index}>
                                ...
                                <td>{row.LeadCustomer}</td>
                                <td>{row.Contact}</td>
                                <td>{row.Project}</td>
                                <td>{row.ProductionOrderDate}</td>
