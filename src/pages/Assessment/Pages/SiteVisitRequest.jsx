...
const SiteVisitRequest = () => {
  ...
  return (
    ...
    <div className='flex flex-row m-[1vw] gap-[1vw] items-center image-hover-effect'>
      <div className='w-[3vw]'>
      <img src="/Assessment/site.png" className="image-hover-effect" alt="Leave" />
      </div>
      <h1 className=' text-[2vw] text-[#E9278E]'>Site Visit Requests</h1>
      </div>
        ...
        <table className="w-[80vw] overflow-y-auto">
          <thead className="bg-gray-300 w-[80vw]">
            <tr className="w-[80vw]">
              ...
              <th className="border p-[0.5vw] text-[1vw]">Visit Date</th>
              <th className="border p-[0.5vw] text-[1vw]">Visit Time</th>
              <th className="border p-[0.5vw] text-[1vw]">Comments</th>
              <th className="border p-[0.5vw] text-[1vw]">Actual Visit Date</th>
