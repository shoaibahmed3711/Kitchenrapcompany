...
const AssestManagement = () => {
  ...
  const filteredRows = rows.filter((row) => {
    const name = row.Suppliername ? row.Suppliername.toLowerCase() : '';
  ...
  return (
    ...
    <div className='flex flex-row m-[1vw] gap-[1vw] items-center image-hover-effect'>
      <div className='w-[3vw]'>
      <img src="/Account/assests.png" className="image-hover-effect" alt="Leave" />
      </div>
      <h1 className=' text-[2vw] text-[#E9278E]'>Assest Management</h1>
      </div>
        ...
        <table className="w-[80vw] overflow-y-auto">
          <thead className="bg-gray-300 w-[80vw]">
            <tr className="w-[80vw]">
              ...
              <th className="border p-[0.5vw] text-[1vw]">Supplier Invoice no</th>
              <th className="border p-[0.5vw] text-[1vw]">Prefix Invoice no</th>
              <th className="border p-[0.5vw] text-[1vw]">Invoice Date</th>
              <th className="border p-[0.5vw] text-[1vw]">Supplier name</th>
              <th className="border p-[0.5vw] text-[1vw]">Currency Value</th>
              <th className="border p-[0.5vw] text-[1vw]">Total Vat</th>
              <th className="border p-[0.5vw] text-[1vw]">Grand Total</th>
              <th className="border p-[0.5vw] text-[1vw]">Amount Paid</th>
              <th className="border p-[0.5vw] text-[1vw]">Total Due</th>
