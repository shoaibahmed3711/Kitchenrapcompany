...
const TaskManagement = () => {
  ...
  return (
    ...
    <div className='flex flex-row m-[1vw] gap-[1vw] items-center image-hover-effect'>
      ...
      <h1 className=' text-[2vw] text-[#E9278E]'>Tax Management</h1>
      </div>
        ...
        <table className="w-[80vw] overflow-y-auto">
          <thead className="bg-gray-300 w-[80vw]">
            <tr className="w-[80vw]">
              ...
              <th className="border p-[0.5vw] text-[1vw]">Payment Date</th>
              <th className="border p-[0.5vw] text-[1vw]">From Date</th>
              <th className="border p-[0.5vw] text-[1vw]">To Date</th>
