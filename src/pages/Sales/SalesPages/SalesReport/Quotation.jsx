...
const Quotation = () => {
  ...
  const addEmployee = () => {
    const newEmployee = {
      id: srNo,
      name: `Employee ${srNo}`,
      advancePurpose: formData.advancePurpose,
        ...
        <table className="w-[80vw] overflow-y-auto">
          <thead className="bg-gray-300 w-[80vw]">
            <tr className="w-[80vw]">
              ...
              <th className="border p-[0.5vw] text-[1vw]">Open till</th>
              <th className="border p-[0.5vw] text-[1vw]">Gross Total</th>
              <th className="border p-[0.5vw] text-[1vw]">Total Discount</th>
              <th className="border p-[0.5vw] text-[1vw]">Total Tax</th>
              <th className="border p-[0.5vw] text-[1vw]">Net Total</th>
          ...
          <tbody className="rounded-lg bg-gray-100 w-[80vw] text-center">
            {filteredRows.map((row, index) => (
              <tr key={index}>
                <td>{index + 1}</td>
                <td>{row.CustomerLead}</td> {/* Customer Lead will be shown */}
                <td>{row.Date}</td> {/* Date will be shown */}
                <td>{row.Opentill}</td> {/* Open till will be shown */}
                <td>{row.GrossTotal}</td> {/* Gross total will be shown */}
        ...
        <div className="w-[26vw] bg-white shadow-2xl absolute right-0 z-10 top-[0vw] overflow-y-auto rounded-lg ml-4 h-[32vw]">
          ...
          <form onSubmit={handleSubmit} className="overflow-y-auto  p-[1vw] ">
            <div className="mb-[0.3vw]">
              {/* Customer/Lead input */}
              <label htmlFor="customerLead" className="block mb-[0.3vw] text-[1vw]">
                Customer/Lead:
              </label>
              <input
                type="text"
            ...
            <div className="mb-[0.3vw]">
              {/* Date input */}
              <label htmlFor="date" className="block mb-[0.3vw] text-[1vw]">
                Date:
              </label>
              <input
                type="date"
            ...
            <div className="mb-[0.3vw]">
              {/* Open till date input */}
              <label htmlFor="openTill" className="block mb-[0.3vw] text-[1vw]">
                Open till date:
              </label>
              <input
                type="date"
            ...
            <div className="mb-[0.3vw]">
              {/* Gross Total input */}
              <label htmlFor="grossTotal" className="block mb-[0.3vw] text-[1vw]">
                Gross Total:
              </label>
              <input
                type="text"
            ...
            <div className="mb-[0.3vw]">
              ...
              <label htmlFor="totalDiscount" className="block mb-[0.3vw] text-[1vw]">
                Total discount:
              </label>
              <input
                type="text"
            ...
            <div className="mb-[0.3vw]">
              {/* Total Tax input */}
              <label htmlFor="totalTax" className="block mb-[0.3vw] text-[1vw]">
                Total Tax:
              </label>
              <input
                type="text"
            ...
            <div className="mb-[0.3vw]">
              {/* Net Total input */}
              <label htmlFor="netTotal" className="block mb-[0.3vw] text-[1vw]">
                Net Total:
              </label>
              <input
                type="text"
