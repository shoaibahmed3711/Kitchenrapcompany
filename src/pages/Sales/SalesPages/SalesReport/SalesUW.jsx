...
const SalesUW = () => {
    const [formData, setFormData] = useState(() => {
        ...
        return savedData ? JSON.parse(savedData) : {
            Employee: '', // Employee name will be entered
            TotalSale: '', // Total Sale will be entered
            TotalAmount: '', // Total amount will be entered
        };
    });
                ...
                <table className="w-[80vw] overflow-y-auto">
                    <thead className="bg-gray-300 w-[80vw]">
                        <tr className="w-[80vw]">
                            ...
                            <th className="border p-[0.5vw] text-[1vw]">Employee</th>
                            <th className="border p-[0.5vw] text-[1vw]">Total Sale</th>
