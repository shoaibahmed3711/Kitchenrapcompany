...
const Roles = () => {
  ...
  return (
    ...
    <div className='flex flex-row m-[1vw] gap-[1vw] items-center image-hover-effect'>
      <div className='w-[3vw]'>
      <img src="/setting/roles.png" className="image-hover-effect" alt="Leave" />
      </div>
      <h1 className=' text-[2vw] text-[#E9278E]'>Roles</h1>
      </div>
        ...
        <table className="w-[80vw] overflow-y-auto">
          <thead className="bg-gray-300 w-[80vw]">
            <tr className="w-[80vw]">
              ...
              <th className="border p-[0.5vw] text-[1vw]">Group Policy</th>
              <th className="border p-[0.5vw] text-[1vw]">Email</th>
              <th className="border p-[0.5vw] text-[1vw]">Access Types</th>
              <th className="border p-[0.5vw] text-[1vw]">Sector</th>
              <th className="border p-[0.5vw] text-[1vw]">Branches</th>
          ...
          <tbody className="rounded-lg bg-gray-100 w-[80vw] text-center">
            {filteredRows.map((row, index) => (
              <tr key={index}>
                ...
                <td>{row.GroupPolicy}</td>
                <td>{row.Email}</td>
                <td>{row.AccessTypes}</td>
                <td>{row.Sector}</td>
                <td>{row.Branches}</td>
