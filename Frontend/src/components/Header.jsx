...
const Header = () => {
  ...
  return (
      ...
      <div className='flex flex-col gap-[0.5vw]'>
        ...
        <div className=' flex flex-col gap-[0.5vw]'>
          ...
          <div className='flex flex-col mx-[.5vw] my-[0.2vw] list-none w-[15vw] rounded-sm p-[0.5vw]' style={{ display: isActive("CRM") }}>
              <li className='p-[0.3vw]'><Link to='/CRM' className={` text-[1vw] hover:text-[#e9278e] ${isLinkActive('/CRM')}`}>CRM Dashboard</Link></li>
          ...
          <div className='bg-gray-200 rounded-[0.2vw]'>
            ...
            <div className='flex flex-col mx-[.5vw] my-[0.2vw] list-none w-[15vw] rounded-sm p-[0.5vw]'  style={{ display: isActive("Sales") }}>
              <li className='p-[0.3vw]'><Link to='/Sales' className={` text-[1vw] hover:text-[#e9278e] ${isLinkActive('/Sales')}`}>Sales Dashboard</Link></li>
    ...
    <div className='bg-white w-[85vw] h-[4vw] border-b-[.1vw] border-[#e9278e]' >
      <button className=''>
      <Link to='/Login' className='text-white rounded-[0.2vw] bg-[#e9278e] flex flex-row items-center gap-[0.3vw] py-[0.5vw] px-[1vw] font-roboto text-[1vw]'>
        Login
        </Link>
        </button>
    </div>
